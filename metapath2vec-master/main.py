...
def parse_args():
	...
	# --walks ./data/test_data/random_walks.txt
	# --types ./data/test_data/node_type_mapings.txt
	# --log ./log
	# --negative-samples 5
	# --window 1
	# --epochs 100
	# --care-type 0 or 1(metapath2vec++)
...
def main(args):
	...
	optimizer = traning_op(loss,LEARNING_RATE=args.lr)  # 定义optimizer
